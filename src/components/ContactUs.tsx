      ...
      <div className="container mx-auto px-4 relative z-10 h-full flex flex-col justify-center py-8">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-gradient-to-r from-[rgb(1,62,139)] to-[#7cb342] text-white px-6 py-2 rounded-full mb-4"
          >
            <MessageCircle size={18} />
            <span className="font-semibold text-xs uppercase tracking-wider">Get In Touch</span>
          </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#7cb342] focus:ring-2 focus:ring-[#7cb342]/20 outline-none transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={3}
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#7cb342] focus:ring-2 focus:ring-[#7cb342]/20 outline-none transition-all resize-none"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-gradient-to-r from-[rgb(1,62,139)] to-[#7cb342] text-white py-4 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all"
                >
                  <Send size={20} />
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${info.gradient} flex items-center justify-center text-white mb-3`}>
                    {info.icon}
                  </div>
                  <h3 className="text-base font-bold text-gray-900 mb-2">{info.title}</h3>
                  {info.details.map((detail, i) => (
                    <p key={i} className="text-gray-600 text-xs mb-1">
                      {detail}
                    </p>
                  ))}
                </motion.div>
            ...
            <div className="bg-gradient-to-br from-[rgb(1,62,139)] to-[#7cb342] rounded-3xl p-6 md:p-8 text-white shadow-xl">
