    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-green-50 snap-section">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute -top-20 -left-20 w-96 h-96 bg-gradient-to-br from-blue-400/30 to-cyan-400/30 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
          ...
          className="absolute top-1/2 -right-20 w-96 h-96 bg-gradient-to-br from-green-400/30 to-emerald-400/30 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1, 1.1, 1],
          ...
          className="absolute -bottom-20 left-1/3 w-96 h-96 bg-gradient-to-br from-purple-400/20 to-pink-400/20 rounded-full blur-3xl"
        />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-[#7cb342] to-green-600 text-white px-6 py-3 rounded-full shadow-lg"
            >
              <Sparkles className="w-5 h-5" />
              <span className="font-semibold text-sm uppercase tracking-wider">Since 2023</span>
            </motion.div>
            ...
            >
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold leading-tight mb-6">
                ...
                <br />
                <span className="text-gray-800 text-5xl md:text-6xl lg:text-7xl">
                  Absolute Purity
                </span>
              </h1>
              <div className="h-2 w-32 bg-gradient-to-r from-[#7cb342] to-green-600 rounded-full mb-6"></div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-md">
                ...
                <span className="text-sm font-semibold text-gray-700">100% Pure</span>
              </div>
              <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-md">
                <Leaf className="w-5 h-5 text-[#7cb342]" />
                <span className="text-sm font-semibold text-gray-700">Farm Fresh</span>
              </div>
              <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-md">
            ...
            >
              <Button
                size="lg"
                className="bg-gradient-to-r from-[rgb(1,62,139)] to-[#7cb342] hover:shadow-xl text-white font-semibold text-lg px-8 py-6 rounded-xl group transition-all"
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-[rgb(1,62,139)] text-[rgb(1,62,139)] hover:bg-[rgb(1,62,139)] hover:text-white font-semibold text-lg px-8 py-6 rounded-xl transition-all"
            ...
            >
              <div>
                <div className="text-3xl font-bold bg-gradient-to-r from-[rgb(1,62,139)] to-[#7cb342] bg-clip-text text-transparent">
                  4+
                </div>
