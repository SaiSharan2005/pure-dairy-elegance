    ...
    <section id="about" className="py-20 bg-gradient-to-b from-white to-secondary/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all animate-slide-up">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all animate-slide-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <div className="bg-primary/10 w-16 h-16 rounded-full flex items-center justify-center mb-6">
